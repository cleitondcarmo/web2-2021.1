...
class ClienteController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect(route('listacliente'))->with('msg', 'Cadastro realizado com sucesso');
    }
    ...
    public function show($id){
        ...
        return view('clientes.clienteshow', ['cliente'=>$cliente]);
    }
    ...
    public function destroy($id){
        ...
        return redirect(route('listacliente'))->with('msg', 'Cadastro apagado');
    }
