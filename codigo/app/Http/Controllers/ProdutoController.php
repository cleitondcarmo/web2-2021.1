...
class ProdutoController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if($request->hasFile('imagem') && $request->file('imagem')->isValid()){
            ...
            $request->imagem->move(public_path('img/produto'), $imagemName);
            $produto->imagem = $imagemName;
        }

        $produto->save();
        return redirect('produto/listaproduto')->with('msg', 'Cadastro realizado com sucesso');
    }
    ...
    public function destroy($id){
        ...
        return redirect('produto/listaproduto')->with('msg', 'Cadastro apagado');
    }
}
